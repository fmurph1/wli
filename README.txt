Install Linux Mint 21.3 Cinnamon Edition from Windows without a USB stick

WARNING: This software is in alpha, and is not recommended for use on your main/critical PC.

You must run the program as administrator and disable secure boot to use this installer.
