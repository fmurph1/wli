...
powershell -Command "Start-BitsTransfer -Source "https://mirrors.layeronline.com/linuxmint/stable/21.3/linuxmint-21.3-xfce-64bit.iso" -Destination "C:\linuxmint-21.3-xfce-64bit.iso""
GOTO SHUTDOWN

:UBU
xcopy /i "%~dp0BootAnISOfile-ubu.cfg" "C:\grub2\windata\customconfigs\BootAnISOfile.cfg" /Y
powershell -Command "Start-BitsTransfer -Source "https://mirrors.edge.kernel.org/ubuntu-releases/24.04/ubuntu-24.04-desktop-amd64.iso" -Destination "C:\ubuntu-24.04-desktop-amd64.iso""
